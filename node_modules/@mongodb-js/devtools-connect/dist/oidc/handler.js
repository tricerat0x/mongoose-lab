...
function oidcServerRequestHandler(options, info) {
    ...
    switch (result) {
        case 'accepted':
            res.end((0, oidc_http_server_pages_1.OIDCAcceptedPage)({ productDocsLink, productName }));
            break;
        case 'rejected':
            res.end((0, oidc_http_server_pages_1.OIDCErrorPage)({ productDocsLink, productName, ...info }));
            break;
        default:
            res.end((0, oidc_http_server_pages_1.OIDCNotFoundPage)({ productDocsLink, productName }));
            break;
    }
}
